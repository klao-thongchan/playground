 def job_search(self, agent):
        """
        Create a task for searching job openings.

        Args:
            agent (Agent): Agent responsible for executing the task.

        Returns:
            Task: A Task object representing the job search task.
        """
        return Task(
    ...
    def resume_analysis(self, agent):
        """
        Create a task for analyzing resumes.

        Args:
            agent (Agent): Agent responsible for executing the task.

        Returns:
            Task: A Task object representing the resume analysis task.
        """
        return Task(
            description=dedent("""
    ...
    def candidate_outreach(self, agent):
        """
        Create a task for crafting outreach messages.

        Args:
            agent (Agent): Agent responsible for executing the task.

        Returns:
            Task: A Task object representing the candidate outreach task.
        """
        return Task(
            description=dedent("""
    ...
    def company_research(self, agent):
        """
        Create a task for researching companies.

        Args:
            agent (Agent): Agent responsible for executing the task.

        Returns:
            Task: A Task object representing the company research task.
        """
        return Task(
            description=dedent("""
    ...
    def final_matching(self, agent):
        """
        Create a task for matching candidates with job openings.

        Args:
            agent (Agent): Agent responsible for executing the task.

        Returns:
            Task: A Task object representing the final matching task.
        """
        return Task(
            description=dedent("""
