...
ANTHROPIC_API_KEY = "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"  # Replace this line with your actual API key
...
2. Keep '\n' character exactly as they appear, do not enter the new line.
3. Maintain consistent translations for repeated terms.
4. Only return the Thai translation, nothing else.
5. Leave Chinese brackets 【】as it is.
6. Do remove 。instead of localized to . or anything else.
