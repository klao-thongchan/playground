...
new Vue({
  ...
  methods: {
    useDataSet1() {
        ...
        this.subLabels = ['Direct Push', 'Service Icon', 'Feature Seller', 'Power Push', 'Unpaid Media', 'Paid Media', 'Feature Buyer', 'Other'];
        this.values = [
          [10520234, 1101772, 327625, 477981, 1192230, 2421628, 25643, 2207074],
          [4367783, 311115, 182482, 196604, 293355, 320619, 25713, 138055],
          [536102, 92892, 41101, 44728, 30913, 13121, 4610, 7471]
        ];
        this.colors = [
