...
class TranslationSystem:
    ...
    def build_translation_assets(self, training_file: str) -> None:
        ...
        print("\nTerm base criteria:")
        print("- Terms appear at least 2 times")
        print("- Terms are between 2-30 characters")
        print("- Terms can be 1-4 words")
        print("- Dominant translation used in >50% of cases")
